...
const ModuleHome = () => {
  ...
  return <form onSubmit={handleSubmit((data)=>{ 
    ...
    <label htmlFor="email" className="font-sans font-light text-[2.6rem] my-11 text-center block leading-6 text-gray-900">
    Log in to your account
    </label>
    <label htmlFor="email" className=" mt-11 text-[15px] text-center block text-sm font-medium leading-6 text-gray-900">
    ...
    <button
        ...
        >
          <p className="mx-3 text-[1.2rem] justify-center flex font-normal font-sans">Next</p> <ArrowRight className="h-5"/>
        </button>
      ...
      <span className="absolute px-3 font-light text-gray-900 -translate-x-1/2 bg-white left-1/2 text-[1rem]">Or Sign in with</span>
  </div>
  ...
  <div className="mt-5 justify-center flex">
    <button
        ...
        >
        <Image className="h-4 w-4" src={google_logo} width={500}  height={500} alt="logo"/>
