            ...
            <div className="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
              ...
              <div>
                ...
                <div className="flex mt-6 items-center justify-center">
                  ...
                  <a
                    href="#"
                    className="flex w-[7.5rem] items-center justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus-visible:ring-transparent"
                  >
                    ...
                    <span className="text-sm font-semibold leading-6 pl-2">Google</span>
                  </a>
