...
// Define the PrivacySetting component
const PrivacySetting = ({ title, description, enabled, onToggle }) => {
  return (
    <div className="card flex border-2 w-1/2 p-5 border-gray-200 mt-2 rounded">
...
// Define the PrivacyPage component
const PrivacyPage = () => {
