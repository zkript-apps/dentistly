      ...
      <div className="card flex border-2 w-1/2 p-5 border-gray-200 mt-4 rounded">
        <div className="flex flex-col">
          <div className="font-semibold pb-2">
            Personalize Canva ads on other websites
          </div>
          <div>
            Canva may use my profile and analytics data to show me personalized
            ads about Canva when I am browsing on other apps and websites.
          </div>
        </div>
